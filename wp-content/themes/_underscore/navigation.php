  <header class="header" role="banner">
    <div class="container">
      <div class="header-logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ladyhops-cropped.png" width="137" height="153" alt="<?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>"></a></div>
